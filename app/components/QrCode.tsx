  ...
  useEffect(() => {
    ...
    qrCode.current.update({
      ...
      cornersSquareOptions: {
        ...
        color:
          qrData.cornerSquareColorType === "single"
            ? qrData.cornerSquareColor
            : undefined,
        gradient:
          qrData.cornerSquareColorType === "gradient"
            ? {
      ...
      cornersDotOptions: {
        ...
        color:
          qrData.cornerDotColorType === "single"
            ? qrData.cornerDotColor
            : undefined,
        gradient:
          qrData.cornerDotColorType === "gradient"
            ? {
      ...
      backgroundOptions: {
        color:
          qrData.backgroundColorType === "single"
            ? qrData.backgroundColor
            : undefined,
        gradient:
          qrData.backgroundColorType === "gradient"
            ? {
        ...
        <Accordion type="single" collapsible defaultValue="data">
          <AccordionItem value="data">
            ...
            <AccordionContent>
              <QrPayloadGenerator
                ...
                setData={setQRPayloadData}
                onChange={(data: string) => {
                  handleQRChange("text", data);
                }}
              />
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="dot">
            ...
            <AccordionContent>
              ...
              {qrData.dotColorType === "single" ? (
                <div>
                  <Label>Dot color</Label>
                  <ColorPickerPopover
                    defaultColor={qrData.dotColor}
                    onChange={(e) => {
                      handleQRChange("dotColor", e);
                    }}
                  />
                </div>
              ) : (
                <div>
                  ...
                  <Select
                    key="gradientType"
                    onValueChange={(e) => {
                      handleQRChange("dotGradientColorType", e);
                    }}
                  >
                  ...
                  <ColorPickerPopover
                    defaultColor={qrData.dotGradientColorOne}
                    onChange={(e) => {
                      handleQRChange("dotGradientColorOne", e);
                    }}
                  />
                  <ColorPickerPopover
                    defaultColor={qrData.dotGradientColorTwo}
                    onChange={(e) => {
                      handleQRChange("dotGradientColorTwo", e);
                    }}
                  />

                  {qrData.dotGradientColorType === "linear" ? (
                    <div className="mt-4">
                      <Label htmlFor="dotGradientRotation">Rotation</Label>
                      <Slider
                        className="mt-2"
                        defaultValue={[qrData.dotGradientRotation]}
                        min={0}
                        max={6}
                        step={1}
                        onValueChange={(e) => {
                          handleQRChange("dotGradientRotation", e);
                        }}
                      />
                    </div>
                  ) : null}
          ...
          <AccordionItem value="cornerSquare">
            ...
            <AccordionContent>
              ...
              <Select
                key="type"
                onValueChange={(e) => {
                  handleQRChange("cornerSquareType", e);
                }}
              >
              ...
              <Select
                key="colorType"
                onValueChange={(e) => {
                  handleQRChange("cornerSquareColorType", e);
                }}
              >
              ...
              {qrData.cornerSquareColorType === "single" ? (
                <div>
                  <Label>Dot color</Label>
                  <ColorPickerPopover
                    defaultColor={qrData.cornerSquareColor}
                    onChange={(e) => {
                      handleQRChange("cornerSquareColor", e);
                    }}
                  />
                </div>
              ) : (
                <div>
                  <Label htmlFor="cornerSquareGradientColorType">
                    Gradient type
                  </Label>
                  <Select
                    key="gradientType"
                    onValueChange={(e) => {
                      handleQRChange("cornerSquareGradientColorType", e);
                    }}
                  >
                    <SelectTrigger
                      id="cornerSquareGradientColorType"
                      className="mb-2"
                    >
                      <SelectValue
                        placeholder={qrData.cornerSquareGradientColorType}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      {gradientStyle.map((item) => {
                  ...
                  <Label>Dot colors</Label>
                  <ColorPickerPopover
                    defaultColor={qrData.cornerSquareGradientColorOne}
                    onChange={(e) => {
                      handleQRChange("cornerSquareGradientColorOne", e);
                    }}
                  />
                  <ColorPickerPopover
                    defaultColor={qrData.cornerSquareGradientColorTwo}
                    onChange={(e) => {
                      handleQRChange("cornerSquareGradientColorTwo", e);
                    }}
                  />

                  {qrData.cornerSquareGradientColorType === "linear" ? (
                    <div className="mt-4">
                      <Label htmlFor="cornerSquareGradientRotation">
                        Rotation
                      </Label>
                      <Slider
                        className="mt-2"
                        defaultValue={[qrData.cornerSquareGradientRotation]}
                        min={0}
                        max={6}
                        step={1}
                        onValueChange={(e) =>
                          handleQRChange("cornerSquareGradientRotation", e)
                        }
                      />
                    </div>
                  ) : null}
          ...
          <AccordionItem value="cornerDot">
            ...
            <AccordionContent>
              ...
              <Select
                key="type"
                onValueChange={(e) => {
                  handleQRChange("cornerDotType", e);
                }}
              >
              ...
              <Select
                key="colorType"
                onValueChange={(e) => {
                  handleQRChange("cornerDotColorType", e);
                }}
              >
              ...
              {qrData.cornerDotColorType === "single" ? (
                <div>
                  <Label>Dot color</Label>
                  <ColorPickerPopover
                    defaultColor={qrData.cornerDotColor}
                    onChange={(e) => {
                      handleQRChange("cornerDotColor", e);
                    }}
                  />
                </div>
              ) : (
                <div>
                  <Label htmlFor="cornerDotGradientColorType">
                    Gradient type
                  </Label>
                  <Select
                    key="gradientType"
                    onValueChange={(e) => {
                      handleQRChange("cornerDotGradientColorType", e);
                    }}
                  >
                    <SelectTrigger
                    ...
                    >
                      <SelectValue
                        placeholder={qrData.cornerDotGradientColorType}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      {gradientStyle.map((item) => {
                  ...
                  <Label>Dot colors</Label>
                  <ColorPickerPopover
                    defaultColor={qrData.cornerDotGradientColorOne}
                    onChange={(e) => {
                      handleQRChange("cornerDotGradientColorOne", e);
                    }}
                  />
                  <ColorPickerPopover
                    defaultColor={qrData.cornerDotGradientColorTwo}
                    onChange={(e) => {
                      handleQRChange("cornerDotGradientColorTwo", e);
                    }}
                  />

                  {qrData.cornerDotGradientColorType === "linear" ? (
                    <div className="mt-4">
                      <Label htmlFor="cornerDotGradientRotation">
                        Rotation
                      </Label>
                      <Slider
                        className="mt-2"
                        defaultValue={[qrData.cornerDotGradientRotation]}
                        min={0}
                        max={6}
                        step={1}
                        onValueChange={(e) =>
                          handleQRChange("cornerDotGradientRotation", e)
                        }
                      />
                    </div>
                  ) : null}
          ...
          <AccordionItem value="background">
            ...
            <AccordionContent>
              ...
              <Select
                key="colorType"
                onValueChange={(e) => {
                  handleQRChange("backgroundColorType", e);
                }}
              >
              ...
              {qrData.backgroundColorType === "single" ? (
                <div>
                  <Label>Dot colors</Label>
                  <ColorPickerPopover
                    defaultColor={qrData.backgroundColor}
                    onChange={(e) => {
                      handleQRChange("backgroundColor", e);
                    }}
                  />
                </div>
              ) : (
                <div>
                  <Label htmlFor="backgroundGradientColorType">
                    Gradient type
                  </Label>
                  <Select
                    key="gradientType"
                    onValueChange={(e) => {
                      handleQRChange("backgroundGradientColorType", e);
                    }}
                  >
                    <SelectTrigger
                    ...
                    >
                      <SelectValue
                        placeholder={qrData.backgroundGradientColorType}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      {gradientStyle.map((item) => {
                  ...
                  <Label>Dot colors</Label>
                  <ColorPickerPopover
                    defaultColor={qrData.backgroundGradientColorOne}
                    onChange={(e) => {
                      handleQRChange("backgroundGradientColorOne", e);
                    }}
                  />
                  <ColorPickerPopover
                    defaultColor={qrData.backgroundGradientColorTwo}
                    onChange={(e) => {
                      handleQRChange("backgroundGradientColorTwo", e);
                    }}
                  />

                  {qrData.backgroundGradientColorType === "linear" ? (
                    <div className="mt-4">
                      <Label htmlFor="backgroundGradientRotation">
                        Rotation
                      </Label>
                      <Slider
                        id="backgroundGradientRotation"
                        className="mt-2"
                        defaultValue={[qrData.backgroundGradientRotation]}
                        min={0}
                        max={6}
                        step={1}
                        onValueChange={(e) =>
                          handleQRChange("backgroundGradientRotation", e)
                        }
                      />
                    </div>
                  ) : null}
              ...
              {qrData.image ? (
                <div className="mt-4">
                  ...
                  <Slider
                    id="imageSize"
                    className="mt-2"
                    defaultValue={[qrData.imageSize]}
                    min={0}
                    max={1}
                    step={0.1}
                    onValueChange={(e) => handleQRChange("imageSize", e)}
                  />
                </div>
              ) : null}
            </AccordionContent>
          ...
          <AccordionItem value="other">
            ...
            <AccordionContent>
              <Label htmlFor="errorType" className="flex items-center">
                Error type
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      ...
                      <p>
                        If you have the code set to H or High, the code will
                        still be readable in case of damage.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
      ...
      <div className="flex flex-col flex-1 justify-start items-center order-1 mb-12 md:order-2 md:mb-0">
        ...
        <div className="flex items-center mt-12">
          <Button
            className="mr-4"
            onClick={() => {
              qrCode?.current?.download({ name: "qr", extension: imageType });
            }}
          >
            Download
          </Button>
          <Select
            key="imageType"
            onValueChange={(e: FileExtension) => setImageType(e)}
          >
